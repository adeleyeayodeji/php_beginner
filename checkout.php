            ...
            <div class="col">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <!-- Flutterwave payment -->
                        <h2>Pay with</h2>
                        <img src="assets/img/Flutterwave.png" id="flutterpay" onclick="makePayment()"
                            style="height: 70px;" alt="">
                    </div>
                    <div class="col-6">
                        <!-- Paystack payment -->
                        <h2>Pay with</h2>
                        <img src="assets/img/1_nhszIhUonirsqTPGelkoFg.jpeg" style="height: 70px;" alt=""
                            id="paystackpay" onclick="payWithPaystack()">
                    </div>
                </div>
                <?php
                    }else{
